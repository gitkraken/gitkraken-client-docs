...
<dl class='horizontal'>
    <dt class='img center'><img src="/wp-content/uploads/gk-hide-icon-green.svg" class='img-responsive' style="width: 70px"></dt>
    <dd>
        <h3>Hide</h3>
    ...
    <dt class='img center'><img src="/wp-content/uploads/gk-solo-icon-orange.svg" class='img-responsive' style="width: 70px"></dt>
    <dd>
        <h3>Solo</h3>
