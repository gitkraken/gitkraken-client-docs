...
3. If there is an existing organization in the left panel to purchase on, select that and select "Purcahse License" (remember you need to have a [role](/gitkraken-client/gitkraken-organization/#roles) with permission to purchase). If no organizations are listed or you intend to purchase on another, select “Create organization.”
