...
- [Team Overview](/gitkraken-client/8x/#team-overview) - Added the <kbd>Team Overview</kbd> section for Workspaces:
  - [Team Pull Requests](/gitkraken-client/8x/#team-pull-requests) - Shows all Pull Requests for repos in Team Workspace and provided quick actions.
  - [Team Issues](/gitkraken-client/8x/#team-issues) - Displays list of all Issues for repos in Team Workspace.
...
- [Workspace UI improvements](/gitkraken-client/8x/#workspace-ui-updates)
...
- [Left panel improvements](/gitkraken-client/8x/#left-panel-improvement) - Left panel filtering experience improved:
...
- [Single Sign On](/gitkraken-client/8x/#what-is-single-sign-on-sso) 
    ...
    - Resources:
        - [Requirements and configuration](/gitkraken-client/8x/#requirements-and-configuration)
        - [Signing in with SSO](/gitkraken-client/8x/#signing-in-with-sso)

- [Overview in Workspaces](/gitkraken-client/8x/#workspace-updates-overview)
...
- [Partial stash](/gitkraken-client/8x/#partial-stash-support)
...
- [Left panel improvements](/gitkraken-client/8x/#left-panel-improvements)
...
- [New Tab view updates](/gitkraken-client/8x/#new-tab-view-updates)
    - The `Recent` and `Favorite Repos` lists have been moved to the top of the `Repositories` section for easier access.
- [More autosuggest in GitKraken CLI](/gitkraken-client/8x/#more-autosuggest-in-gitkraken-cli)
...
- GitKraken Client now supports the ability to create and apply patches.
    - [Create patch from commit(s)](/gitkraken-client/8x/#create-patch-from-commits)
    - [Create patch from uncommitted file(s)](/gitkraken-client/8x/#create-patch-from-files)
    - [Create patch from Command Palette](/gitkraken-client/8x/#create-patch-from-command-palette)
    - [Apply patch from Command Palette](/gitkraken-client/8x/#apply-patch-from-command-palette)
- [Left panel improvements](/gitkraken-client/8x/#left-panel-improvements-toggle-sections) - Left Panel now has a context menu to toggle visibility of the different sections.
- [New Tab update](/gitkraken-client/8x/#updated-ui-and-layout-for-new-tab-view) - Updated UI and layout.
- [Terminal Tab](/gitkraken-client/8x/#repo-aliases-in-terminal-tab-titles) - Repo aliases will now show in Terminal Tab titles.
- [More fuzzy search](/gitkraken-client/8x/#fuzzy-search-in-gk-history-and-gk-blame-commands) - Enabled fuzzy search in `gk history` and `gk blame` commands in GitKraken CLI.
- [Search tabs list](/gitkraken-client/8x/#users-may-now-search-tabs-by-repo-alias-in-the-tabs-list) - Users may now search tabs by repo alias in the tabs list.
- [Naming branch from issue](/gitkraken-client/8x/#name-branch-when-creating-branch-from-issue) - When viewing an issue from inside GitKraken Client, there is now a short text field for naming the branch when creating a branch from the issue.
- [Git LFS performance improvements](/gitkraken-client/8x/#git-lfs-performance-improvements):
